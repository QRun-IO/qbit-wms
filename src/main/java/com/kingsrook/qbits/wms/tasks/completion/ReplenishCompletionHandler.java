/*******************************************************************************
 ** Completion handler for REPLENISH tasks.  Moves inventory from source
 ** location to pick face location.  Inserts a REPLENISH transaction, deducts
 ** from source, and adds to destination (perpetual inventory).
 *******************************************************************************/
...
public class ReplenishCompletionHandler extends AbstractTaskCompletionHandler
{
   private static final QLogger LOG = QLogger.getLogger(ReplenishCompletionHandler.class);
   ...
   public void handle(QRecord task) throws QException
   {
      ...
      LOG.info("Handling REPLENISH task completion",
      ...
      {
         LOG.warn("REPLENISH task has no quantity completed, skipping inventory changes", logPair("taskId", taskId));
         return;
      }

      /////////////////////////////////////////////////////////////////////////
      // Step 1: Insert REPLENISH transaction (MUST come first)              //
      /////////////////////////////////////////////////////////////////////////
      createInventoryTransaction(
         ...
         null,
         completedBy,
         "Replenish task " + taskId + " completed"
      );
      ...
      /////////////////////////////////////////////////////////////////////////
      // Step 3: Add to destination (pick face) location                     //
      /////////////////////////////////////////////////////////////////////////
